# Performance tests
## How to run
*NB: clean and package in the top project*
...
Maybe Fibonacci and List are slightly slower, but not clear
|Benchmark                                                      |Mode | Cnt |    Score  |   Error    |Units|
|---------------------------------------------------------------|-----|-----|-----------|------------|-----|
|BubblesortBenchmark.sort_java                                  |avgt |   5 |    19,101 |±   1,370  |us/op|
|BubblesortBenchmark.sort_tailspin_iterate                      |avgt |   5 |    33,930 |±   2,188  |us/op|
|BubblesortBenchmark.sort_tailspin_iterate_measure              |avgt |   5 |    37,031 |±   1,738  |us/op|
|BubblesortBenchmark.sort_tailspin_iterate_tagged_long          |avgt |   5 |    37,822 |±  11,706  |us/op|
|BubblesortBenchmark.sort_tailspin_recurse                      |avgt |   5 |    37,500 |±   2,730  |us/op|
|BubblesortBenchmark.sort_tailspin_recurse_full_precondition    |avgt |   5 |    53,417 |±   1,524  |us/op|
|BubblesortBenchmark.sort_tailspin_recurse_non_auxiliary        |avgt |   5 |    84,328 |±   2,321  |us/op|
|BubblesortBenchmark.sort_tailspin_recurse_simple_precondition  |avgt |   5 |    37,173 |±   0,839  |us/op|
|FibonacciBenchmark.recursive_java                              |avgt |   5 |    35,262 |±   1,999  |us/op|
|FibonacciBenchmark.recursive_tailspin_array_long               |avgt |   5 |  1484,055 |± 115,819  |us/op|
|FibonacciBenchmark.recursive_tailspin_bignumber                |avgt |   5 |   539,805 |±  39,608  |us/op|
|FibonacciBenchmark.recursive_tailspin_measure_long             |avgt |   5 |   132,753 |±   7,928  |us/op|
|FibonacciBenchmark.recursive_tailspin_rational                 |avgt |   5 |  1383,452 |±  99,602  |us/op|
|FibonacciBenchmark.recursive_tailspin_raw_long                 |avgt |   5 |    74,922 |±   4,060  |us/op|
|FibonacciBenchmark.recursive_tailspin_scinum                   |avgt |   5 |   900,753 |±  36,414  |us/op|
|FibonacciBenchmark.recursive_tailspin_small_scinum             |avgt |   5 |   380,144 |±  21,822  |us/op|
|FibonacciBenchmark.recursive_tailspin_structure_measure        |avgt |   5 |  8502,633 |± 462,454  |us/op|
|HilbertBenchmark.rational_tailspin                             |avgt |   5 |  8319,904 |± 340,683  |us/op|
|HilbertBenchmark.small_rational_tailspin                       |avgt |   5 |  1456,744 |±  52,794  |us/op|
|ListBenchmark.list_java                                        |avgt |   5 |    22,286 |±   0,957  |us/op|
|ListBenchmark.list_tailspin_empty                              |avgt |   5 |   856,527 |±  24,868  |us/op|
|ListBenchmark.list_tailspin_optional                           |avgt |   5 |   884,751 |±  43,401  |us/op|
|NBodyBenchmark.nbody_java_big_decimal                          |avgt |   5 | 11176,747 |± 578,195  |us/op|
|NBodyBenchmark.nbody_java_double                               |avgt |   5 |    15,090 |±   0,610  |us/op|
|NBodyBenchmark.nbody_tailspin_16digits                         |avgt |   5 | 15134,443 |± 869,210  |us/op|
|NBodyBenchmark.nbody_tailspin_6digits                          |avgt |   5 |  3946,014 |± 329,200  |us/op|
|PascalBenchmark.triangle_java                                  |avgt |   5 |    11,446 |±   0,683  |us/op|
...
|Benchmark                                                      |Mode | Cnt |    Score  |   Error    |Units|
|---------------------------------------------------------------|-----|-----|-----------|------------|-----|
|BubblesortBenchmark.sort_java                                  |avgt |   5 |    19,270 |±    0,832  |us/op|
|BubblesortBenchmark.sort_tailspin_iterate                      |avgt |   5 |    34,812 |±    1,624  |us/op|
|BubblesortBenchmark.sort_tailspin_iterate_measure              |avgt |   5 |    37,536 |±    1,225  |us/op|
|BubblesortBenchmark.sort_tailspin_iterate_tagged_long          |avgt |   5 |    37,275 |±    1,378  |us/op|
|BubblesortBenchmark.sort_tailspin_recurse                      |avgt |   5 |    32,935 |±    1,186  |us/op|
|BubblesortBenchmark.sort_tailspin_recurse_full_precondition    |avgt |   5 |    49,572 |±    3,369  |us/op|
|BubblesortBenchmark.sort_tailspin_recurse_non_auxiliary        |avgt |   5 |   124,589 |±   17,622  |us/op|
|BubblesortBenchmark.sort_tailspin_recurse_simple_precondition  |avgt |   5 |    33,448 |±    0,801  |us/op|
|FibonacciBenchmark.recursive_java                              |avgt |   5 |    35,996 |±    1,190  |us/op|
|FibonacciBenchmark.recursive_tailspin_array_long               |avgt |   5 |  2079,979 |±  135,692  |us/op|
|FibonacciBenchmark.recursive_tailspin_bignumber                |avgt |   5 |   770,570 |±   29,378  |us/op|
|FibonacciBenchmark.recursive_tailspin_measure_long             |avgt |   5 |   501,982 |±   20,639  |us/op|
|FibonacciBenchmark.recursive_tailspin_rational                 |avgt |   5 |  1765,690 |±  184,847  |us/op|
|FibonacciBenchmark.recursive_tailspin_raw_long                 |avgt |   5 |    77,310 |±    2,359  |us/op|
|FibonacciBenchmark.recursive_tailspin_scinum                   |avgt |   5 |  1259,421 |±   88,162  |us/op|
|FibonacciBenchmark.recursive_tailspin_small_scinum             |avgt |   5 |   617,773 |±   18,408  |us/op|
|FibonacciBenchmark.recursive_tailspin_structure_measure        |avgt |   5 |  9655,040 |±  308,151  |us/op|
|HilbertBenchmark.rational_tailspin                             |avgt |   5 |  9418,941 |±  494,859  |us/op|
|HilbertBenchmark.small_rational_tailspin                       |avgt |   5 |  1748,197 |±   88,490  |us/op|
|ListBenchmark.list_java                                        |avgt |   5 |    22,627 |±    0,533  |us/op|
|ListBenchmark.list_tailspin_empty                              |avgt |   5 |  5490,759 |±  957,831  |us/op|
|ListBenchmark.list_tailspin_optional                           |avgt |   5 |  5216,796 |±  833,313  |us/op|
|NBodyBenchmark.nbody_java_big_decimal                          |avgt |   5 | 11387,167 |±  668,534  |us/op|
|NBodyBenchmark.nbody_java_double                               |avgt |   5 |    15,504 |±    0,205  |us/op|
|NBodyBenchmark.nbody_tailspin_16digits                         |avgt |   5 | 15858,659 |± 2172,474  |us/op|
|NBodyBenchmark.nbody_tailspin_6digits                          |avgt |   5 |  4056,902 |±  263,371  |us/op|
|PascalBenchmark.triangle_java                                  |avgt |   5 |    11,586 |±    0,597  |us/op|
|PascalBenchmark.triangle_tailspin                              |avgt |   5 |    24,758 |±    8,495  |us/op|
|SelectionSortBenchmark.selection_sort_java                     |avgt |   5 |    56,296 |±    3,797  |us/op|
|SelectionSortBenchmark.selection_sort_tailspin                 |avgt |   5 |   520,489 |±   19,469  |us/op|

2026-05-24 fix bug: use range values instead of range iteration
I can't explain why some values are radically smaller now. Warning about Compiler Blackholes
|Benchmark                                                      |Mode | Cnt |    Score  |   Error    |Units|
|---------------------------------------------------------------|-----|-----|-----------|------------|-----|
|BubblesortBenchmark.sort_java                                  |avgt |   5 |    19,289 |±    0,906  |us/op|
|BubblesortBenchmark.sort_tailspin_iterate                      |avgt |   5 |    34,067 |±    1,678  |us/op|
|BubblesortBenchmark.sort_tailspin_iterate_measure              |avgt |   5 |    36,781 |±    1,033  |us/op|
|BubblesortBenchmark.sort_tailspin_iterate_tagged_long          |avgt |   5 |    37,068 |±    1,238  |us/op|
|BubblesortBenchmark.sort_tailspin_recurse                      |avgt |   5 |    37,463 |±    1,827  |us/op|
|BubblesortBenchmark.sort_tailspin_recurse_full_precondition    |avgt |   5 |    52,982 |±    2,344  |us/op|
|BubblesortBenchmark.sort_tailspin_recurse_non_auxiliary        |avgt |   5 |    84,475 |±    4,088  |us/op|
|BubblesortBenchmark.sort_tailspin_recurse_simple_precondition  |avgt |   5 |    37,730 |±    1,587  |us/op|
|FibonacciBenchmark.recursive_java                              |avgt |   5 |    37,333 |±    1,810  |us/op|
|FibonacciBenchmark.recursive_tailspin_array_long               |avgt |   5 |  1638,314 |±  200,569  |us/op|
|FibonacciBenchmark.recursive_tailspin_bignumber                |avgt |   5 |   535,230 |±   23,753  |us/op|
|FibonacciBenchmark.recursive_tailspin_measure_long             |avgt |   5 |   134,234 |±    5,357  |us/op|
|FibonacciBenchmark.recursive_tailspin_rational                 |avgt |   5 |  1458,230 |±   68,876  |us/op|
|FibonacciBenchmark.recursive_tailspin_raw_long                 |avgt |   5 |    74,987 |±    3,967  |us/op|
|FibonacciBenchmark.recursive_tailspin_scinum                   |avgt |   5 |   989,610 |±   48,644  |us/op|
|FibonacciBenchmark.recursive_tailspin_small_scinum             |avgt |   5 |   381,764 |±   22,335  |us/op|
|FibonacciBenchmark.recursive_tailspin_structure_measure        |avgt |   5 |  8447,965 |±  426,539  |us/op|
|HilbertBenchmark.rational_tailspin                             |avgt |   5 |  8067,676 |±  188,816  |us/op|
|HilbertBenchmark.small_rational_tailspin                       |avgt |   5 |  1410,376 |±   58,238  |us/op|
|ListBenchmark.list_java                                        |avgt |   5 |    22,165 |±    1,027  |us/op|
|ListBenchmark.list_tailspin_empty                              |avgt |   5 |   862,692 |±   56,713  |us/op|
|ListBenchmark.list_tailspin_optional                           |avgt |   5 |   864,447 |±   32,382  |us/op|
|NBodyBenchmark.nbody_java_big_decimal                          |avgt |   5 | 11015,386 |±  657,923  |us/op|
|NBodyBenchmark.nbody_java_double                               |avgt |   5 |    14,908 |±    0,571  |us/op|
|NBodyBenchmark.nbody_tailspin_16digits                         |avgt |   5 | 14885,423 |± 2269,963  |us/op|
|NBodyBenchmark.nbody_tailspin_6digits                          |avgt |   5 |  3728,939 |±  328,322  |us/op|
|PascalBenchmark.triangle_java                                  |avgt |   5 |    11,779 |±    1,598  |us/op|
|PascalBenchmark.triangle_tailspin                              |avgt |   5 |    20,525 |±    1,566  |us/op|
|SelectionSortBenchmark.selection_sort_java                     |avgt |   5 |    48,506 |±    3,858  |us/op|
|SelectionSortBenchmark.selection_sort_tailspin                 |avgt |   5 |   480,233 |±   23,771  |us/op|
