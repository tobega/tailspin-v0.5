...
public abstract class ScopeSendToTemplatesNode extends TransformNode {
  @Child
  @Executed
  ...
  protected ScopeSendToTemplatesNode(int chainCvSlot, Templates templates, int definitionLevel) {
    this.valueNode = ReadContextValueNode.create(-1, chainCvSlot);
    this.definitionLevel = definitionLevel;
    this.templates = templates;
  }

  public static ScopeSendToTemplatesNode create(int chainCvSlot, Templates templates, int definitionLevel) {
    return ScopeSendToTemplatesNodeGen.create(chainCvSlot, templates, definitionLevel);
  }
