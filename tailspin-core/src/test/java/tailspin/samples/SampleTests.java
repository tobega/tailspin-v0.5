...
public class SampleTests {
  private static final String[] SAMPLE_FILES = new String[] {
      "Integers.tests", "Chain.tests", "Templates.tests", "Array.tests", "SciNums.tests", "Range.tests", "Matchers.tests",
      "Structure.tests", "Types.tests", "State.tests", "Measures.tests", "TypeBounds.tests",
      "Rationals.tests", "Strings.tests", "General.tests", "Tags.tests", "Preconditions.tests"
  };
