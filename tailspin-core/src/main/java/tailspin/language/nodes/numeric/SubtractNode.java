...
public abstract class SubtractNode extends ValueNode {
  ...
  public static abstract class DoSubtractNode extends Node {
    public abstract Object executeSubtract(Node node, Object left, Object right);
  ...
  protected Measure doMeasure(Measure left, Measure right,
    ...
    return new Measure(doSubtractNode.executeSubtract(this, left.value(), right.value()), left.unit());
  }

  @Specialization(guards = "isUntypedRegion")
  protected Object doUntypedMeasures(Measure left, Measure right,
      @Cached(inline = true) @Shared DoSubtractNode doSubtractNode) {
    return doSubtractNode.executeSubtract( this, left.value(), right.value());
  }

  @Specialization(guards = "isUntypedRegion")
  protected Object doUntypedMeasureRight(Object left, Measure right,
      @Cached(inline = true) @Shared DoSubtractNode doSubtractNode) {
    return doSubtractNode.executeSubtract(this, left, right.value());
  }

  @Specialization(guards = "isUntypedRegion")
  protected Object doUntypedMeasureLeft(Measure left, Object right,
      @Cached(inline = true) @Shared DoSubtractNode doSubtractNode) {
    return doSubtractNode.executeSubtract(this, left.value(), right);
  }

  @Specialization
  protected Object doOther(Object left, Object right,
      @Cached(inline = true) @Shared DoSubtractNode doSubtractNode) {
    return doSubtractNode.executeSubtract(this, left, right);
  }
